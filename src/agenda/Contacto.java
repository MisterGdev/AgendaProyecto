...
public class Contacto {
	...
	private class Telefono {
		...
		private Telefono(String prefijo, int numero) {
			this.prefijo = prefijo;
			this.numero = numero;
		}
		
		private void setPrefijo(String prefijo) {
			this.prefijo = prefijo;
		}
	 ...
	 */
	public void addTelefono(String descripcion, Telefono telefono) {
		//Se añade la descripción en mayúsculas para evitar confusiones del usuario.
		telefonos.put(descripcion.toUpperCase(), new Telefono);
	}
